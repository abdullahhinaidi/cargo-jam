...
const OBSTACLE_LEVELS = [
  ...
  // 32 — a maintenance/excavation zone low and to one side, so the deep crowded corner stays
  makeMapLevel({ cols: 9, rows: 8, slots: 4, bays: 4, lives: 3, patience: 43, matCount: 6, bigEvery: 4,
    obstacles: [{ x: 4, y: 4, w: 4, h: 2, kind: 'roadwork' }] }),
  ...
  makeMapLevel({ cols: 9, rows: 8, slots: 5, bays: 4, lives: 3, patience: 42, matCount: 6, bigEvery: 4,
    obstacles: [{ x: 2, y: 1, w: 1, h: 2, kind: 'roadwork' }, { x: 6, y: 1, w: 1, h: 2, kind: 'water' },
